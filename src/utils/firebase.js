...
import { getAuth, signInWithRedirect, signInWithPopup, createUserWithEmailAndPassword, signInWithEmailAndPassword, GoogleAuthProvider, signOut, onAuthStateChanged } from "firebase/auth";
...
export const singInUserAccountWithEmailAndPassword = async (email, password) => {
    if (!email || !password) {
        return;
    }
